...
function Barra({ valor, cor = 'bg-violet', max = 100 }) {
  ...
  // cor chega como classe bg-*; o fio usa a mesma cor via --cor
  return (
    <div className="fio" style={{ '--cor': `var(--color-${cor.slice(3)})` }}>
      <i><i style={{ width: pct }} /></i>
      <b style={{ left: pct }} />
    </div>
  )
}
